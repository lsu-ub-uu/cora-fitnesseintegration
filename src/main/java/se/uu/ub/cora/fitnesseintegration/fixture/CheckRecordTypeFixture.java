...
public class CheckRecordTypeFixture {
	...
	public String assertDefinitionIs() {
		...
		JavaClientAppTokenCredentials cred = new JavaClientAppTokenCredentials(
				SystemUrl.getRestUrl(), SystemUrl.getAppTokenVerifierUrl() + "rest/",
		...
		// TODO: 1. fix systemUrl to return getAppTokenVerifierRestUrl
		// TOOD: 2. move this to clientHolder.getJavaClientForFitnesseAdmin
		// TODO: 3. refactor this class to use 2
		// TODO: 4. refactor definitionWriter to use 2
